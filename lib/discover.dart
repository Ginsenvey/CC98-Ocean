  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("发现",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),)
            ...
            separatorBuilder: (_, __) {
              if(!kIsWeb){
                if(Platform.isWindows||Platform.isLinux||Platform.isMacOS){
                  return Divider(height: 1,thickness: 1, color: const Color.fromARGB(255, 232, 244, 249));
                }
                else{
                  return Divider(height: 1,thickness: 6, color: const Color.fromARGB(255, 232, 244, 249));
                }
              }
              else{
                return Divider(height: 1, thickness: 1,color: const Color.fromARGB(255, 232, 244, 249));
